...
import './HomeImageSlider.styled.scss';

import firstBannerTopLeftImage from './../../assets/home/background/bg-home-slide-1_2.png';
import firstBannerTopRightImage from './../../assets/home/background/bg-home-slide-1_3.png';
import firstBannerBotLeftImage from './../../assets/home/background/bg-home-slide-1_4.png';
import firstBannerMainImage from './../../assets/home/background/bg-home-slide-1_1.png';
...
const HomeImageSlider = () => {
    ...
    return(
        <div className="banner">
            ...
            <div className="banner__second hide--banner">
                <div className="banner__content">
                    <div className="banner__content--delivery">
                        <h4>Delivery in 24h</h4>
                    </div>
